...
Canon::Canon(float x, float y, float z, color_t color) {
    ...
    this->canon_bbox.height = 200;
    this->canon_bbox.width = 200;
    this->canon_bbox.depth = 30;
    this->canon_bbox.x = x;
    this->canon_bbox.y = y;
    this->canon_bbox.z = z;

    this->canon_bbox2.height = 5;
    this->canon_bbox2.width = 5;
    this->canon_bbox2.depth = 5;
    this->canon_bbox2.x = x;
    this->canon_bbox2.y = y;
    this->canon_bbox2.z = z;
    ...
    static const GLfloat vertex_buffer_data2[] = {
        2.0f, 0.1f, -2.0f, // triangle 1 : begin
        -2.0f, 0.1f, -2.0f,
        -2.0f, 0.1f, 2.0f, // triangle 1 : end
        -2.0f, 0.1f, 2.0f, // triangle 2 : begin
        2.0f, 0.1f, -2.0f,
        2.0f, 0.1f, 2.0f, // triangle 2 : end
    };
